...
const SearchBar = () => {
    ...
    return (
        <div class="my-3 ">
          <div class="relative flex flex-wrap p-0 justify-center justify-items-center mx-10">
            <input
              type="search"
            ...
            <span
              class="input-group-text flex items-center whitespace-nowrap rounded px-3 py-1.5 text-center text-base font-normal text-neutral-700 dark:text-neutral-200 max-w-5xl"
              id="basic-addon2">
              <svg
